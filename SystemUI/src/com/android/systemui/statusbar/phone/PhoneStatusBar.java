...
public class PhoneStatusBar extends StatusBar implements NavigationBarView.OnViewPagerItemInstantiatedListener {
    ...
    private void prepareNavigationBarView() {
        ...
        mNavigationBarView.setListener(this);
...
//            Slog.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
    ...
    public void onItemInstantiated(View view) {
        ...
        view.setOnTouchListener(mRecentsPanel);
    }
}
